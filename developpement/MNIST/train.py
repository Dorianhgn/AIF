...
def train(net, optimizer, train_loader, val_loader, writer, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        val_loss = test(net, val_loader)
        writer.add_scalar('validation accuracy', val_loss, epoch)
...
def test(model, dataloader):
    ...
    with torch.no_grad():
        for x, y in dataloader:
            ...
            total += y.size(0)
    return test_corrects / total, loss.item()
